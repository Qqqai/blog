...
CREATE TABLE `bk_articles`  (
  ...
  CONSTRAINT `bk_articles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `bk_users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- ----------------------------
-- Table structure for bk_sorts
-- ----------------------------
DROP TABLE IF EXISTS `bk_sorts`;
CREATE TABLE `bk_sorts`  (
  `sort_id` bigint(20) NOT NULL COMMENT '分类ID',
